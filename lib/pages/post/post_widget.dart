                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await FotosRecord.collection
                            .doc()
                            .set(createFotosRecordData(
                              foto: _model.uploadedFileUrl,
                              data: _model.datePicked,
                              idade: int.tryParse(_model.idadeController.text),
                              obs: _model.descricaoController.text,
                              nomeFoto: _model.nomeController.text,
                              teste: _model.idadeController.text,
                            ));
